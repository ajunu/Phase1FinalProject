	...
	public void filemanager() throws IOException{
        ...
        do {
            ...
            switch (optionChoosen) {
                ...
                case 5:
                    exit = true;
                    System.out.println("Thank you for using Lockers Pvt.com SEE YOU SOON!!");
                    break;
                default:
                    System.out.println("Incorrect option : Choose the option from  1 to 5 to perform the below operations");
                    exit = true;
                    break;
            }
        }
